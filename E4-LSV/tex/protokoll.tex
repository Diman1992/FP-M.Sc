...
Dataset 6 & & $9.2\cdot 10^{2}$
 ...
 \label{tab:expEvents}
\end{table}
The event numbers are calculated by $N=\mathcal{L}\sigma (A\times \epsilon)$ with the luminosity $\mathcal{L}=1$ fb$^{-1}$ and the acceptance times
